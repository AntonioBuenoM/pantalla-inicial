        ...
        <div className='flex justify-center flex-col w-[90%] sm:w-[80%] h-full mx-auto'>
            <div className='grid grid-cols-1 lg:grid-cols-2 items-center gap-12'>
                ...
                <div>
                    ...
                    {/*Heading */}
                    <h1 className='text-2xl sm:text-4xl md:text-5xl mt-6 mb-6 font-bold md:leading-[3rem] lg:leading-[3.5rem]'>The premier workspace companion for you daily needs.</h1>
                     {/*Description */}
                     <p className='text-gray-700'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Numquam iusto labore asperiores ad voluptatum at doloribus est inventore facilis eveniet.</p>
